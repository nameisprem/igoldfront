                        ...
                        <Container className="main-container">
                            <div className="d-flex">
                                ...
                                <Link className="logo-horizontal " href={`/components/dashboard/dashboard/`}>
                                    <img style={{width:100,height:100}} src={"../../../assets/maillogo.png"} className="header-brand-img desktop-logo" alt="logo" />
                                    <img style={{width:100,height:100}} src={"../../../assets/images/brand/logo-dark.png"} className="header-brand-img light-logo1" alt="logo" />
                                </Link>
                                {/* <!-- LOGO --> */}
                                    ...
                                    <Row>
                                        <Navbar className="main-sidemenu navbar px-0 justify-content-between">
                                            <NavbarBrand className="ps-0 d-none d-lg-block" href={`/components/dashboard/dashboard/`}>
                                                ...
                                                <img style={{width:100,height:100}} src={"../../../assets/maillogo.png"} className="logo-3" alt="logo" />
                                            </NavbarBrand>
