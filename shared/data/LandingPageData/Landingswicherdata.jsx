...
export const LtrtoRtl = () => {
    ...
    document.getElementById("bootstrapLink")?.setAttribute("href", `${process.env.PUBLIC_URL === 'production' ? "https://nextjs.spruko.com/assets" : "https://nextjs.spruko.com/assets"}/plugins/bootstrap/css/bootstrap.rtl.min.css`)
...
export const RtltoLtr = () => {
    ...
    document.getElementById("bootstrapLink")?.setAttribute("href", `${process.env.PUBLIC_URL === 'production' ? "https://nextjs.spruko.com/assets" : "https://nextjs.spruko.com/assets"}/plugins/bootstrap/css/bootstrap.min.css`)
