          ...
          <Card.Body>
            <div className="">
              ...
              <div className="d-sm-flex overflow-visible mt-5">
                <img className="card-aside-column br-5 cover-image" alt="media19" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/media/22.jpg`} />
                <div className="ps-3 flex-column">
              ...
              <div className="d-sm-flex overflow-visible mt-5">
                <img className="card-aside-column br-5 cover-image" alt="media19" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/media/12.jpg`} />
                <div className="ps-3 flex-column">
              ...
              <div className="d-sm-flex overflow-visible mt-5">
                <img className="card-aside-column br-5 cover-image" alt="media19" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/media/25.jpg`} />
                <div className="ps-3 flex-column">
          ...
          <Card.Body>
            <div className="">
              <div className="d-flex overflow-visible">
                <img className="avatar bradius avatar-xl me-3" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/12.jpg`} alt="avatar-img" />
              ...
              <div className="d-flex overflow-visible mt-5">
                <img className="avatar bradius avatar-xl me-3" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/2.jpg`} alt="avatar-img" />
                <div className="media-body valign-middle">
              ...
              <div className="d-flex overflow-visible mt-5">
                <img className="avatar bradius avatar-xl me-3" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/9.jpg`} alt="avatar-img" />
                <div className="media-body valign-middle">
              ...
              <div className="d-flex overflow-visible mt-5">
                <img className="avatar bradius avatar-xl me-3" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/4.jpg`} alt="avatar-img" />
                <div className="media-body valign-middle">
