                ...
                <div className="predefined_styles">
                  ...
                  <div className="swichermainleft">
                    ...
                    <div className="skin-body switch_section">
                      ...
                      <div className="switch-toggle d-flex mt-2">
                        <Link className="bg-img1" href="#" onClick={() => SwitcherData.bgimage1()} ><img src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/media/bg-img1.jpg`} alt="Bg-1" id="bgimage1" /></Link>
                        <Link className="bg-img2" href="#" onClick={() => SwitcherData.bgimage2()}><img src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/media/bg-img2.jpg`} alt="Bg-2" id="bgimage2" /></Link>
                        <Link className="bg-img3" href="#" onClick={() => SwitcherData.bgimage3()}><img src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/media/bg-img3.jpg`} alt="Bg-3" id="bgimage3" /></Link>
                        <Link className="bg-img4" href="#" onClick={() => SwitcherData.bgimage4()}><img src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/media/bg-img4.jpg`} alt="Bg-4" id="bgimage4" /></Link>
                      </div>
                    </div>
                  </div>
