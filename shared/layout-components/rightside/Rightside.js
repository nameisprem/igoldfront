                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-2'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/2.jpg`} />
                        </div>
                        <div className="">
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-11'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/11.jpg`} />
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-10'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/10.jpg`} />
                        </div>
                        <div className="">
                          <Link href={`/components/apps/chat/`}>
                            <div className="fw-semibold text-dark" data-bs-toggle="modal"
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-13'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/13.jpg`} />
                        </div>
                        <div className="">
                          <Link href={`/components/apps/chat/`}>
                            <div className="fw-semibold text-dark" data-bs-toggle="modal"
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-7'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/7.jpg`} />
                          <span className="avatar-status bg-success"></span>
                        </div>
                        <div className="">
                          <Link href={`/components/apps/chat/`}>
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-9'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/9.jpg`} />
                        </div>
                        <div className="">
                          <Link href={`/components/apps/chat/`}>
                            <div className="fw-semibold text-dark" data-bs-toggle="modal"
                      ...
                      <ListGroup.Item className="d-flex align-items-center">
                        <div className="me-2">
                          <img className="avatar avatar-md brround cover-image" alt='user-14'
                            src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/14.jpg`} />
                        </div>
                        <div className="">
                          <Link href={`/components/apps/chat/`}>
                            <div className="fw-semibold text-dark" data-bs-toggle="modal"
