        ...
        <PerfectScrollbar options={{ suppressScrollX: true, useBothWheelAxes: false }}>
          <div className="side-header">
            <Link className="header-brand1" href={`/components/dashboard/dashboard/`}>
              <img src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/maillogo.png`} style={{width:70,height:70}} className="header-brand-img desktop-logo" alt="logo1" />
              {/* <img src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/brand/icon-white.png`} className="header-brand-img toggle-logo" alt="logo-2" /> */}
              {/* <img src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/brand/icon-dark.png`} className="header-brand-img light-logo" alt="logo-3" /> */}
              {/* <img src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/brand/logo-dark.png`} className="header-brand-img light-logo1" alt="logo-4" /> */}
            </Link>
          </div>
