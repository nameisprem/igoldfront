        ...
        <div className="container-fluid main-container">
          <div className="d-flex">
            ...
            <Link className="logo-horizontal " href={`/components/dashboard/dashboard/`}>
              <img src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/brand/logo-white.png`} className="header-brand-img desktop-logo" alt="logo" />
              <img src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/brand/logo-dark.png`} className="header-brand-img light-logo1" alt="logo" />
            </Link>
                  ...
                  <div className="d-flex order-lg-2">
                          ...
                          <Row as='ul' className="p-3">
                            <Col lg={6} as='li' className="mb-2">
                              <Link href="#" className="btn btn-country btn-lg btn-block active">
                                <span className="country-selector"><img alt="" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/flags-img/us_flag.jpg`}
                            ...
                            <Col lg={6} as='li' className="mb-2">
                              <Link href="#" className="btn btn-country btn-lg btn-block">
                                <span className="country-selector"><img alt=""
                                  src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/flags-img/italy_flag.jpg`}
                            ...
                            <Col lg={6} as='li' className="mb-2">
                              <Link href="#" className="btn btn-country btn-lg btn-block">
                                <span className="country-selector"><img alt=""
                                  src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/flags-img/spain_flag.jpg`}
                            ...
                            <Col lg={6} as='li' className="mb-2">
                              <Link href="#" className="btn btn-country btn-lg btn-block">
                                <span className="country-selector"><img alt=""
                                  src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/flags-img/india_flag.jpg`}
                            ...
                            <Col lg={6} as='li' className="mb-2">
                              <Link href="#" className="btn btn-country btn-lg btn-block">
                                <span className="country-selector"><img alt=""
                                  src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/flags-img/french_flag.jpg`}
                            ...
                            <Col lg={6} as='li' className="mb-2">
                              <Link href="#" className="btn btn-country btn-lg btn-block">
                                <span className="country-selector"><img alt=""
                                  src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/flags-img/russia_flag.jpg`}
                            ...
                            <Col lg={6} as='li' className="mb-2">
                              <Link href="#" className="btn btn-country btn-lg btn-block">
                                <span className="country-selector"><img alt=""
                                  src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/flags-img/germany_flag.jpg`}
                            ...
                            <Col lg={6} as='li' className="mb-2">
                              <Link href="#" className="btn btn-country btn-lg btn-block">
                                <span className="country-selector"><img alt=""
                                  src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/flags-img/argentina.jpg`}
                                  className="me-3 language" /></span>Argentina
                              </Link>
                            </Col>
                            <Col lg={6} as='li' className="mb-2">
                              <Link href="#" className="btn btn-country btn-lg btn-block">
                                <span className="country-selector"><img alt="" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/flags-img/malaysia.jpg`}
                                  className="me-3 language" /></span>Malaysia
                              </Link>
                            </Col>
                            <Col lg={6} as='li' className="mb-2">
                              <Link href="#" className="btn btn-country btn-lg btn-block">
                                <span className="country-selector"><img alt="" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/flags-img/turkey.jpg`}
                      ...
                      <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <PerfectScrollbar style={{ height: "300px" }}>
                          <Dropdown.Item href={`/components/e-commerce/shopping-cart/`} className="d-flex p-4">
                            ...
                            <img className="avatar avatar-xl br-5 me-3 align-self-center cover-image" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/products/3.jpg`}alt='pngs-4' />
                          ...
                          <Dropdown.Item href={`/components/e-commerce/shopping-cart/`} className="d-flex p-4">
                            ...
                            <img
                              ...
                              src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/products/5.jpg`}/>
                            <div className="wd-50p">
                          ...
                          <Dropdown.Item href={`/components/e-commerce/shopping-cart/`} className="d-flex p-4">
                            ...
                            <img
                              ...
                              src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/products/11.jpg`}/>
                            <div className="wd-50p">
                          ...
                          <Dropdown.Item href={`/components/e-commerce/shopping-cart/`} className="d-flex p-4">
                            ...
                            <img
                              ...
                              src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/products/1.jpg`}/>
                            <div className="wd-50p">
                          ...
                          <Dropdown.Item href={`/components/e-commerce/shopping-cart/`} className="d-flex p-4">
                            ...
                            <img
                              ...
                              src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/products/2.jpg`}/>
                            <div className="wd-50p">
                        ...
                        <div className="message-menu">
                          <Dropdown.Item className="d-flex" href={`/components/apps/chat/`}>
                            <img
                              ...
                              src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/1.jpg`}/>
                          ...
                          <Dropdown.Item className="d-flex" href={`/components/apps/chat/`}>
                            <img
                              ...
                              src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/15.jpg`}/>
                            <div className="wd-90p">
                              <div className="d-flex">
                          ...
                          <Dropdown.Item className="d-flex" href={`/components/apps/chat/`}>
                            <img
                              ...
                              src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/12.jpg`}/>
                            <div className="wd-90p">
                              <div className="d-flex">
                          ...
                          <Dropdown.Item className="d-flex" href={`/components/apps/chat/`}>
                            <img
                              ...
                              src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/4.jpg`}/>
                            <div className="wd-90p">
                              <div className="d-flex">
                    ...
                    <Dropdown className=" profile-1">
                      <Dropdown.Toggle variant='' className="nav-link leading-none d-flex no-caret">
                        <img src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/21.jpg`}alt="profile-user"
