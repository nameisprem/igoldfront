        ...
        <div className="container-fluid main-container">
          <div className="d-flex">
            ...
            <Link className="logo-horizontal " href={`/components/dashboard/dashboard/`}>
              <img src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/maillogo.png`} style={{width:55,height:55}} className="header-brand-img desktop-logo" alt="logo" />
              <img src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/maillogo.png`} style={{width:55,height:55}} className="header-brand-img light-logo1" alt="logo" />
            </Link>
                        ...
                        <PerfectScrollbar style={{ height: "300px"  }} className="header-dropdown-list message-menu">
                          {FiltershopingData !== "" ? shopingData.map((idx) => (
                            <Dropdown.Item href={`/components/e-commerce/shopping-cart/`} className="d-flex p-4" key={Math.random()}>
                              ...
                              <img className="avatar avatar-xl br-5 me-3 align-self-center cover-image" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}${idx.preview}`} alt='pngs-4' />
