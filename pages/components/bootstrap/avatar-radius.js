            ...
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="avatar-list">
                  <img className="avatar bradius cover-image" alt='user1' src={"../../../assets/images/users/1.jpg"} />
                  <img className="avatar bradius cover-image" alt='user2' src={"../../../assets/images/users/2.jpg"} />
                  <img className="avatar bradius cover-image" alt='user3' src={"../../../assets/images/users/1.jpg"} />
                  <img className="avatar bradius cover-image" alt='user4' src={"../../../assets/images/users/2.jpg"} />
                  <img className="avatar bradius cover-image" alt='user5' src={"../../../assets/images/users/3.jpg"} />
                </div>
              </div>
            </div>
          </Card.Body>
              ...
              <div className="example">
                <div className="avatar-list">
                  ...
                  <div className=" avatar avatar-md bradius cover-image" >
                    <img className=" bradius cover-image" alt='user5' src={"../../../assets/images/users/5.jpg"} />
                    <span className="badge rounded-pill avatar-badges bg-secondary fs-10">1</span>
                  </div>

                  <div className=" avatar avatar-md bradius cover-image" >
                    <img className=" bradius cover-image" alt='user9' src={"../../../assets/images/users/9.jpg"} />
                    <span className="badge rounded-pill avatar-badges bg-danger fs-10">4</span>
                  </div>

                  <div className=" avatar avatar-md bradius cover-image" >
                    <img className=" bradius cover-image" alt='user6' src={"../../../assets/images/users/6.jpg"} />
                    <span className="badge rounded-pill avatar-badges bg-success fs-10">6</span>
                  </div>

                  <div className="  avatar avatar-md bradius cover-image" >
                    <img className=" bradius cover-image" alt='user7' src={"../../../assets/images/users/7.jpg"} />
              ...
              <div className="example">
                <div className="avatar-list">
                  ...
                  <div className="avatar avatar-xl bradius cover-image" >
                    <img className=" bradius cover-image" alt='user21' src={"../../../assets/images/users/21.jpg"} />
            ...
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="avatar-list avatarstatus">
                  <img className="avatar bradius cover-image" alt='user 21' src={"../../../assets/images/users/21.jpg"} />
            ...
            <div className="text-wrap ">
              ...
              <div className="example">
                <div className="avatar-list avatar-list-stacked">
                  <img className="avatar bradius cover-image" alt='user21' src={"../../../assets/images/users/21.jpg"} />
                  <img className="avatar bradius cover-image" alt='user21' src={"../../../assets/images/users/21.jpg"} />
                  <img className="avatar bradius cover-image" alt='user9' src={"../../../assets/images/users/9.jpg"} />
                  <img className="avatar bradius cover-image" alt='user21' src={"../../../assets/images/users/21.jpg"} />
                  <img className="avatar bradius cover-image" alt='user11' src={"../../../assets/images/users/11.jpg"} />
        ...
        <Card>
          ...
          <Card.Body>
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="avatar-list">
                  <img className="avatar avatar-sm bradius cover-image" alt='user4' src={"../../../assets/images/users/4.jpg"} />
                  <img className="avatar bradius cover-image" alt='user3' src={"../../../assets/images/users/3.jpg"} />
                  <img className="avatar avatar-md bradius cover-image" alt='user5' src={"../../../assets/images/users/5.jpg"} />
                  <img className="avatar avatar-lg bradius cover-image" alt='user6' src={"../../../assets/images/users/6.jpg"} />
                  <img className="avatar avatar-xl bradius cover-image" alt='user4' src={"../../../assets/images/users/4.jpg"} />
                  <img className="avatar avatar-xxl bradius cover-image" alt='user7' src={"../../../assets/images/users/7.jpg"} />
                </div>
              </div>
            </div>
          </Card.Body>
