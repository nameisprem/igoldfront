...
import { alertCard, DefaultAlertList, AlertData, LinkAlertList, IconAlertList, AlertList, AvatarList, IconDismissList } from '../../../shared/data/bootstrap/booststrapAlertsData';
            ...
            <Alert className="bg-white border p-0 pb-3 mb-5">
              <Card.Header className="border-0 pt-3">
                <div className="card-options">
                  <Link href="#" onClick={() => { handleAlertRemove(idx.id) }}><i className="fe fe-x icon-dimiss"></i></Link>
                </div>
              </Card.Header>
              ...
              <Card.Footer className="text-center border-0 pt-0">
                <Row>
                  <div className="text-center">
                    <Link href="#" className="btn btn-white me-2">cancel</Link>
                    <Link href="#" className={`btn btn-${idx.color}`}>{idx.buttonName}</Link>
                  </div>
                </Row>
              </Card.Footer>
            </Alert>
