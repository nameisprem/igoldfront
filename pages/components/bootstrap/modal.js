...
`}
        ...
        <Card.Body>
          <Row>
            <Col sm={6} md={6} xl={3}>
              <Link href="#" className="modal-effect btn btn-primary-light d-grid mb-3" onClick={() => viewDemoShow1("show1")}>Zoom</Link>
              <Rodal onClose={hide} visible={animation1} animation='Zoom' height={280} onClick={() => viewDemoClose1("show1")} >
                <div className='modal-header'>Mesage Preview
                  <Link href="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show1") }}><i className='fe fe-x ms-auto'></i></Link>
                </div>
            ...
            <Col sm={6} md={6} xl={3}>
              <Link href="#" className="modal-effect btn btn-secondary-light d-grid mb-3" onClick={() => viewDemoShow1("show2")}>Fade</Link>
              <Rodal onClose={hide} visible={animation2} animation='fade' height={280}>
                <div className='modal-header'>Mesage Preview
                  <Link href="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show2") }}><i className='fe fe-x ms-auto'></i></Link>
                </div>
                <div className='modal-body'>
                  <h6>Modal Body</h6>
                  Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</div>
            ...
            <Col sm={6} md={6} xl={3}>
              <Link href="#" className="modal-effect btn btn-danger-light d-grid mb-3" onClick={() => viewDemoShow1("show3")}>Flip</Link>
              <Rodal onClose={hide} visible={animation3} animation='flip' height={280}>
                <div className='modal-header'>Mesage Preview
                  <Link href="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show3") }}><i className='fe fe-x ms-auto'></i></Link>
                </div>
                <div className='modal-body'>
                  <h6>Modal Body</h6>
                  Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</div>
            ...
            <Col sm={6} md={6} xl={3}>
              <Link href="#" className="modal-effect btn btn-warning-light d-grid mb-3" onClick={() => viewDemoShow1("show4")}>Door</Link>
              <Rodal onClose={hide} visible={animation4} animation='door' height={280}>
                <div className='modal-header'>Modal Header
                  <Link href="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show4") }}><i className='fe fe-x ms-auto'></i></Link>
                </div>
                <div className='modal-body'>
                  <h6>Modal Body</h6>
                  Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</div>
            ...
            <Col sm={6} md={6} xl={3}>
              <Link href="#" className="modal-effect btn btn-success-light d-grid mb-3" onClick={() => viewDemoShow1("show5")}>Rotate</Link>
              <Rodal onClose={hide} visible={animation5} animation='rotate' height={280}>
                <div className='modal-header'>Modal Header
                  <Link href="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show5") }}><i className='fe fe-x ms-auto'></i></Link>
                </div>
                <div className='modal-body'>
                  <h6>Modal Body</h6>
                  Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</div>
            ...
            <Col sm={6} md={6} xl={3}>
              <Link href="#" className="modal-effect btn btn-info-light d-grid mb-3" onClick={() => viewDemoShow1("show6")}>Slide-Up</Link>
              <Rodal onClose={hide} visible={animation6} animation='slideUp' height={280}>
                <div className='modal-header'>Modal Header
                  <Link href="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show6") }}><i className='fe fe-x ms-auto'></i></Link>
                </div>
                <div className='modal-body'>
                  <h6>Modal Body</h6>
                  Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</div>
            ...
            <Col sm={6} md={6} xl={3}>
              <Link href="#" className="modal-effect btn btn-primary-light d-grid mb-3" onClick={() => viewDemoShow1("show7")}>slide-Down</Link>
              <Rodal onClose={hide} visible={animation7} animation='slideDown' height={280}>
                <div className='modal-header'>Modal Header
                  <Link href="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show7") }}><i className='fe fe-x ms-auto'></i></Link>
                </div>
                <div className='modal-body'>
                  <h6>Modal Body</h6>
                  Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</div>
            ...
            <Col sm={6} md={6} xl={3}>
              <Link href="#" className="modal-effect btn btn-secondary-light d-grid mb-3" onClick={() => viewDemoShow1("show8")}>slide-Left</Link>
              <Rodal onClose={hide} visible={animation8} animation='slideLeft' height={280}>
                <div className='modal-header'>Modal Header
                  <Link href="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show8") }}><i className='fe fe-x ms-auto'></i></Link>
                </div>
                <div className='modal-body'>
                  <h6>Modal Body</h6>
                  Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</div>
            ...
            <Col sm={6} md={6} xl={3}>
              <Link href="#" className="modal-effect btn btn-danger-light d-grid mb-3" onClick={() => viewDemoShow1("show9")}>slide-Right</Link>
              <Rodal onClose={hide} visible={animation9} animation='slideRight' height={280}>
                <div className='modal-header'>Modal Header
                  <Link href="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show9") }}><i className='fe fe-x ms-auto'></i></Link>
                </div>
                <div className='modal-body'>
                  <h6>Modal Body</h6>
                  Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</div>
