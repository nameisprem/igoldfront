        ...
        <Card>
          ...
          <Card.Body>
            <div className="text-wrap">
              <div className="example">
                <div className="tags">
                  <Link href="#" className="tag">First tag</Link>
                  <Link href="#" className="tag">Second tag</Link>
                  <Link href="#" className="tag">Third tag</Link>
                </div>
              </div>
            </div>
          </Card.Body>
        ...
        <Card>
          ...
          <Card.Body>
            <div className="text-wrap">
              <div className="example">
                <div className="tags">
                  <span className="tag tag-rounded tag-icon tag-red"><i className="fe fe-map-pin"></i>First tag <Link href="#" className="tag-addon tag-addon-cross tag-red"><i className="fe fe-x text-white m-1"></i></Link></span>
                  <span className="tag tag-rounded tag-icon tag-green"><i className="fe fe-calendar"></i>Second tag <Link href="#" className="tag-addon tag-addon-cross tag-green"><i className="fe fe-x text-white m-1"></i></Link></span>
                  <span className="tag tag-rounded tag-icon tag-orange"><i className="fe fe-bell"></i>Third tag <Link href="#" className="tag-addon tag-addon-cross tag-orange"><i className="fe fe-x text-white m-1"></i></Link></span>
                  <span className="tag tag-rounded tag-icon tag-pink"><i className="fe fe-filter"></i>Third tag <Link href="#" className="tag-addon tag-addon-cross tag-pink"><i className="fe fe-x text-white m-1"></i></Link></span>
                </div>
              </div>
            </div>
          </Card.Body>
          ...
          <Card.Body>
            <div className="text-wrap">
              <div className="example">
                <div className="tags">
                  <span className="tag">
                    <img className="tag-avatar avatar cover-image" alt='user11' src={"../../../assets/images/users/11.jpg"} />Victoria
                  </span>
                  <span className="tag">
                    <img className="tag-avatar avatar cover-image" alt='user4' src={"../../../assets/images/users/4.jpg"} /> Nathan
                  </span>
                  <span className="tag">
                    <img className="tag-avatar avatar cover-image" alt='user1' src={"../../../assets/images/users/1.jpg"} /> Alice
                  </span>
                  <span className="tag">
                    <img className="tag-avatar avatar cover-image" alt='user18' src={"../../../assets/images/users/18.jpg"} /> Rose
                  </span>
                  <span className="tag">
                    <img className="tag-avatar avatar cover-image" alt='user16' src={"../../../assets/images/users/16.jpg"} /> Peter
                  </span>
                  <span className="tag">
                    <img className="tag-avatar avatar cover-image" alt='user6' src={"../../../assets/images/users/6.jpg"} /> Wayne
                  </span>
                  <span className="tag">
                    <img className="tag-avatar avatar cover-image" alt='user7' src={"../../../assets/images/users/7.jpg"} /> Michelle
                  </span>
                  <span className="tag">
                    <img className="tag-avatar avatar cover-image" alt='user17' src={"../../../assets/images/users/17.jpg"} /> Debra
                  </span>
                </div>
              </div>
            </div>
