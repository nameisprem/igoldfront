            ...
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="avatar-list">
                  <img className="avatar  brround cover-image" alt='user12' src={"../../../assets/images/users/12.jpg"} />
                  <img className="avatar  brround cover-image" alt='user13' src={"../../../assets/images/users/13.jpg"} />
                  <img className="avatar  brround cover-image" alt='user11' src={"../../../assets/images/users/11.jpg"} />
                  <img className="avatar  brround cover-image" alt='user12' src={"../../../assets/images/users/12.jpg"} />
                  <img className="avatar  brround cover-image" alt='user14' src={"../../../assets/images/users/14.jpg"} />
                </div>
              </div>
            </div>
          </Card.Body>
            ...
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="avatar-list avatar-list-stacked">
                  <img className="avatar brround cover-image" alt='user12' src={"../../../assets/images/users/12.jpg"} />
                  <img className="avatar brround cover-image" alt='user1' src={"../../../assets/images/users/1.jpg"} />
                  <img className="avatar brround cover-image" alt='user19' src={"../../../assets/images/users/19.jpg"} />
                  <img className="avatar brround cover-image" alt='user2' src={"../../../assets/images/users/2.jpg"} />
                  <img className="avatar brround cover-image" alt='user14' src={"../../../assets/images/users/14.jpg"} />
        ...
        <Card>
          ...
          <Card.Body>
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="avatar-list">
                  <img className="avatar avatar-sm brround cover-image" alt='user15' src={"../../../assets/images/users/15.jpg"} />
                  <img className="avatar brround cover-image" alt='user13' src={"../../../assets/images/users/13.jpg"} />
                  <img className="avatar avatar-md brround cover-image" alt='user16' src={"../../../assets/images/users/16.jpg"} />
                  <img className="avatar avatar-lg brround cover-image" alt='user17' src={"../../../assets/images/users/17.jpg"} />
                  <img className="avatar avatar-xl brround cover-image bg-transparent" alt='user14' src={"../../../assets/images/users/14.jpg"} />
                  <img className="avatar avatar-xxl brround cover-image" alt='user18' src={"../../../assets/images/users/18.jpg"} />
                </div>
              </div>
            </div>
          </Card.Body>
              ...
              <div className="example">
                <div className="avatar-list avatarstatus">
                  ...
                  <div className="avatar brround cover-image" >
                    <img className=" brround cover-image" alt='user15' src={"../../../assets/images/users/15.jpg"} />
                    <span className="avatar-status bg-secondary"></span>
                  </div>


                  <div className="avatar brround cover-image" >
                    <img className=" brround cover-image" alt='user20' src={"../../../assets/images/users/20.jpg"} />
                    <span className="avatar-status bg-red"></span>
                  </div>

                  <div className="avatar brround cover-image" >
                    <img className=" brround cover-image" alt='user11' src={"../../../assets/images/users/11.jpg"} />
                    <span className="avatar-status bg-green"></span>
                  </div>

                  <div className="avatar brround cover-image" >
                    <img className=" brround cover-image" alt='user17' src={"../../../assets/images/users/17.jpg"} />
              ...
              <div className="example">
                <div className="avatar-list">
                  ...
                  <div className="avatar avatar-md brround cover-image" >
                    <img className=" brround cover-image" alt='user5' src={"../../../assets/images/users/19.jpg"} />
                    <span className="badge rounded-pill avatar-badges bg-primary fs-10">3</span>
                  </div>

                  <div className="avatar avatar-md brround cover-image" >
                    <img className=" brround cover-image" alt='user5' src={"../../../assets/images/users/15.jpg"} />
