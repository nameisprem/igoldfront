...
const BlogDetails = () => {
  ...
  <div >
    ...
    <Row>
      <Col xl={8}>
        <Card>
          <img className="card-img-top " src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/media/27.jpg`} alt="blog11" />
          <Card.Body>
            <div className="d-md-flex">
              <Link href="#" className="d-flex me-4 mb-2"><i className="fe fe-calendar fs-16 me-1 p-3 bg-secondary-transparent text-secondary bradius"></i>
                <div className="mt-0 mt-3 ms-1 text-muted font-weight-semibold">Sep-25-2021</div>
              </Link>
              <Link href={`/components/pages/profile/`} className="d-flex mb-2"><i className="fe fe-user fs-16 me-1 p-3 bg-primary-transparent text-primary bradius"></i>
                <div className="mt-0 mt-3 ms-1 text-muted font-weight-semibold">Harry Fisher</div>
              </Link>
              <div className="ms-auto">
                <Link href="#" className="d-flex mb-2"><i className="fe fe-message-square fs-16 me-1 p-3 bg-success-transparent text-success bradius"></i>
          ...
          <Card.Body>
            <h3><Link href="#"> Voluptatem quia voluptas</Link></h3>
          ...
          <Card.Body className="pb-0">
            <div className="media mb-5 overflow-visible d-block d-sm-flex">
              <div className="me-3 mb-2">
                <Link href={`/components/pages/profile/`}> <img className="media-object rounded-circle thumb-sm" alt="64x64" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/5.jpg`} /> </Link>
              </div>
              <div className="media-body overflow-visible">
                <div className="border mb-5 p-4 br-5">
                  ...
                  <span className="reply" id="1">
                    <Link href="#"><Badge className="btn-primary-light rounded-pill py-2 px-3"><i className="fe fe-corner-up-left me-1 d-inline-block"></i>Reply</Badge></Link>
                  </span>
                </div>
                <div className="media mb-5 overflow-visible">
                  <div className="me-3">
                    <Link href={`/components/pages/profile/`}> <img className="media-object rounded-circle thumb-sm" alt="64x64" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/2.jpg`} /> </Link>
                  </div>
                  <div className="media-body border p-4 overflow-visible br-5">
                    ...
                    <Link className="like" href="#"><Badge bg='danger-light' className="btn-danger-light rounded-pill py-2 px-3 me-2"><i className="fe fe-heart me-1"></i>56</Badge></Link>
                    <span className="reply" id="2">
                      <Link href="#"><Badge bg='primary-light' className="btn-primary-light rounded-pill py-2 px-3"><i className="fe fe-corner-up-left me-1 d-inline-block"></i>Reply</Badge></Link>
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="media mb-5 overflow-visible">
              <div className="me-3">
                <Link href={`/components/pages/profile/`}> <img className="media-object rounded-circle thumb-sm" alt="64x64" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/15.jpg`} /> </Link>
              </div>
              <div className="media-body overflow-visible">
                <div className="border mb-5 p-4 br-5">
                ...
                <div className="media mb-5 overflow-visible d-block d-sm-flex">
                  ...
                  <div className="media-body overflow-visible">
                    ...
                    <div className="media overflow-visible">
                      <div className="me-3">
                        <Link href={`/components/pages/profile/`}> <img className="media-object rounded-circle thumb-sm" alt="64x64" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/9.jpg`} /> </Link>
                      </div>
                      <div className="media-body border p-4 overflow-visible br-5">
                        <nav className="nav float-end">
                          <Dropdown>
      ...
      <Col xl={4}>
        ...
        <Card>
          ...
          <Card.Body>
            <ListGroup>
              <ListGroup.Item className="border-0 p-0"><Link href="#"><i className="fe fe-chevron-right d-inline-flex"></i> Development</Link> <span className="product-label">22</span> </ListGroup.Item>
              <ListGroup.Item className="border-0 p-0"><Link href="#"><i className="fe fe-chevron-right d-inline-flex"></i> Web Design</Link> <span className="product-label">15</span> </ListGroup.Item>
              <ListGroup.Item className="border-0 p-0"><Link href="#"><i className="fe fe-chevron-right d-inline-flex"></i> Technology</Link> <span className="product-label">10</span> </ListGroup.Item>
              <ListGroup.Item className="border-0 p-0"><Link href="#"><i className="fe fe-chevron-right d-inline-flex"></i> Sports</Link> <span className="product-label">88</span> </ListGroup.Item>
            </ListGroup>
          </Card.Body>
        </Card>
          ...
          <Card.Body>
            <div className="">
              <div className="d-flex overflow-visible">
                <img className="avatar bradius avatar-xl me-3" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/1.jpg`} alt="avatar-img" />
                <div className="media-body valign-middle">
                  <Link href={`/components/pages/profile/`} className="fw-semibold text-dark">Simon Sais</Link>
              ...
              <div className="d-flex overflow-visible mt-5">
                <img className="avatar bradius avatar-xl me-3" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/3.jpg`} alt="avatar-img" />
                <div className="media-body valign-middle">
                  <Link href={`/components/pages/profile/`} className="fw-semibold text-dark">Cherry Blossom</Link>
                  <p className="text-muted mb-0">There are many variations of passages of Lorem Ipsum available ...</p>
                </div>
              </div>
              <div className="d-flex overflow-visible mt-5">
                <img className="avatar bradius avatar-xl me-3" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/5.jpg`} alt="avatar-img" />
                <div className="media-body valign-middle">
                  <Link href={`/components/pages/profile/`} className="fw-semibold text-dark">Ivan Notheridiya</Link>
                  <p className="text-muted mb-0">There are many variations of passages of Lorem Ipsum available ...</p>
                </div>
              </div>
              <div className="d-flex overflow-visible mt-5">
                <img className="avatar bradius avatar-xl me-3" src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/users/15.jpg`} alt="avatar-img" />
                <div className="media-body valign-middle">
                  <Link href={`/components/pages/profile/`} className="fw-semibold text-dark">Manny Jah</Link>
                  <p className="text-muted mb-0">There are many variations of passages of Lorem Ipsum available ...</p>
                </div>
              </div>
            </div>
          ...
          <Card.Body>
            <div className="">
              <div className="d-sm-flex overflow-visible">
                <img className="card-aside-column br-5 cover-image" alt='media19' src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/media/19.jpg`} />
              ...
              <div className="d-sm-flex overflow-visible mt-5">
                <img className="card-aside-column br-5 cover-image" alt='media22' src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/media/22.jpg`} />
                <div className="ps-3 flex-column">
              ...
              <div className="d-sm-flex overflow-visible mt-5">
                <img className="card-aside-column br-5 cover-image" alt='media12' src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/media/12.jpg`} />
                <div className="ps-3 flex-column">
                  <h4><Link href={`/components/pages/extension/blog-details/`}>Generator on the Internet..</Link></h4>
                  <div className="text-muted">Excepteur sint occaecat cupidatat non proident, accusantium sunt in culpa qui officia deserunt mollit anim id est laborum....</div>
                </div>
              ...
              <div className="d-sm-flex overflow-visible mt-5">
                <img className="card-aside-column br-5 cover-image" alt='media25' src={`${url}${process.env.NODE_ENV === 'production' ? '/' : "/"}assets/images/media/25.jpg`} />
                <div className="ps-3 flex-column">
                  <h4><Link href={`/components/pages/extension/blog-details/`}>Voluptatem quia voluptas...</Link></h4>
                  <div className="text-muted">Excepteur sint occaecat cupidatat non proident, accusantium sunt in culpa qui officia deserunt mollit anim id est laborum....</div>
                </div>
        ...
        <Card>
          ...
          <Card.Body>
            <div className="tags">
              ...
              <Link href="#" className="tag">Design</Link>
              <Link href="#" className="tag">Technology</Link>
              <Link href="#" className="tag">Popular</Link>
              <Link href="#" className="tag">Codiegniter</Link>
              <Link href="#" className="tag">JavaScript</Link>
              <Link href="#" className="tag">Bootstrap</Link>
              <Link href="#" className="tag">PHP</Link>
            </div>
          </Card.Body>
        </Card>
      </Col>
