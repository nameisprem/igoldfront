        ...
        <Card>
          <Card.Body>
            <ListGroup className="list-group-transparent mb-0 file-manager file-manager-border">
              <h4>General</h4>
              <div>
                <Link href='#'><ListGroup.Item eventKey='#link' className="d-flex align-items-center px-0 border-top br-bs-0 br-be-0">
                  <i className="fe fe-user fs-18 me-2 text-success p-2"></i>Account
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link href='#'><ListGroup.Item eventKey="#link1" className="d-flex align-items-center  px-0 br-0 ">
                  <i className="fe fe-bell fs-18 me-2 text-secondary p-2"></i>Notifications
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link href='#'><ListGroup.Item eventKey="#link2" className="d-flex align-items-center  px-0 br-0">
                  <i className="fe fe-eye fs-18 me-2 text-primary p-2"></i> Appearances
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link href='#'><ListGroup.Item eventKey="#link3" className="d-flex align-items-center  px-0 br-0">
                  <i className="fe fe-lock fs-18 me-2 text-warning p-2"></i> Privacy & Security
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link href='#'><ListGroup.Item eventKey="#link4" className="d-flex align-items-center  px-0 br-0">
                  <i className="fe fe-headphones fs-18 me-2 text-info p-2"></i> Help & Support
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link href='#'><ListGroup.Item eventKey="#link5" className="d-flex align-items-center  px-0 br-0">
                  <i className="fe fe-database fs-18 me-2 text-pink p-2"></i> Data Usage Control
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link href='#'><ListGroup.Item eventKey="#link6" className="d-flex align-items-center  px-0 br-0">
                  <i className="fe fe-battery-charging fs-18 me-2 text-green p-2"></i> Power Saving Management
                </ListGroup.Item></Link>
              </div>
              <div>
                <Link href='#'><ListGroup.Item eventKey="#link7" className="d-flex align-items-center px-0 br-ts-0 br-te-0">
              ...
              <Card.Body>
                <Row>
                  ...
                  <Col xl={10} sm={10} md={12}>
                    ...
                    <Link href="">Change Settings <i className="ion-chevron-right fs-10 ms-1"></i></Link>
                  </Col>
                </Row>
              </Card.Body>
            </Card>
