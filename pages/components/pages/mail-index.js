      ...
      <Col xl={3}>
        <Card>
          <ListGroup className="list-group-transparent mb-0 mail-inbox pb-3" defaultActiveKey='#link'>
            ...
            <Link href='#'><ListGroup.Item  className="d-flex align-items-center mx-4">
              ...
              <div className="mail-option">
                ...
                <ButtonGroup className="hidden-phone">
                  <Dropdown>
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item href="#"><i className="fa fa-pencil me-2"></i> Mark as Read</Dropdown.Item>
                      <Dropdown.Item href="#"><i className="fa fa-ban me-2"></i> Spam</Dropdown.Item>
                      <Dropdown.Divider />
                      <Dropdown.Item href="#"><i className="fa fa-trash-o me-2"></i> Delete</Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                </ButtonGroup>
                <ul className="unstyled inbox-pagination">
                  ...
                  <li>
                    <Link className="np-btn" href="#"><i className="fa fa-angle-right pagination-right"></i></Link>
                  </li>
                </ul>
              </div>
                      ...
                      <tbody>
                        {tableData.map((item) => (
                          <tr className={item.className} key={item.id}>
                            ...
                            <td className="view-message dont-show fw-semibold clickable-row" ><Link href={`/components/pages/mail-read/`} className='text-dark'>{item.subject}</Link></td>
                            <td className="view-message clickable-row" ><Link href={`/components/pages/mail-read/`} className='text-dark'>{item.description}</Link></td>
