      ...
      <ul className="notification">
          ...
          <div className="notification-body">
            <div className="media mt-0">
              <div className="main-avatar avatar-md online">
                <img alt="avatar" className="br-7" src={"../../../assets/images/users/1.jpg"}/>
              </div>
        ...
        <li>
          ...
          <div className="notification-body">
            <div className="media mt-0">
              <div className="main-avatar avatar-md online">
                <img alt="avatar" className="br-7" src={"../../../assets/images/users/2.jpg"}/>
              </div>
              <div className="media-body ms-3 d-flex">
                <div className="">
        ...
        <li>
          ...
          <div className="notification-body">
            <div className="media mt-0">
              <div className="main-avatar avatar-md online">
                <img alt="avatar" className="br-7" src={"../../../assets/images/users/12.jpg"}/>
              </div>
              <div className="media-body ms-3 d-flex">
                <div className="">
        ...
        <li>
          ...
          <div className="notification-body">
            <div className="media mt-0">
              <div className="main-avatar avatar-md offline">
                <img alt="avatar" className="br-7" src={"../../../assets/images/users/13.jpg"}/>
              </div>
              <div className="media-body ms-3 d-flex">
                <div className="">
        ...
        <li>
          ...
          <div className="notification-body">
            <div className="media mt-0">
              <div className="main-avatar avatar-md online">
                <img alt="avatar" className="br-7" src={"../../../assets/images/users/4.jpg"}/>
              </div>
              <div className="media-body ms-3 d-flex">
                <div className="">
        ...
        <li>
          ...
          <div className="notification-body">
            <div className="media mt-0">
              <div className="main-avatar avatar-md offline">
                <img alt="avatar" className="br-7" src={"../../../assets/images/users/14.jpg"}/>
              </div>
              <div className="media-body ms-3 d-flex">
                <div className="">
