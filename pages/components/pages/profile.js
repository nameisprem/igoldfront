                    ...
                    <div className="panel profile-cover">
                      ...
                      <div className="profile-cover__img">
                        <div className="profile-img-1">
                          <img src={"../../../assets/images/users/21.jpg"} alt="user21" />
                        </div>
        ...
        <Row>
          <Col xl={3}>
            ...
            <Card>
              ...
              <Card.Body>
                <div className="tags">
                  <Link href="#" className="tag">Laravel</Link>
                  <Link href="#" className="tag">Angular</Link>
                  <Link href="#" className="tag">HTML</Link>
                  <Link href="#" className="tag">Vuejs</Link>
                ...
                <div className="main-profile-contact-list">
                  <div className="me-5">
                    <div className="media mb-4">
                      ...
                      <div className="media-body">
                        <h6 className="font-weight-semibold mb-1">Web Designer at <Link href="#" className="btn-link">Spruko</Link></h6>
                  ...
                  <div className="me-5 mt-5 mt-md-0">
                    <div className="media mb-4">
                      ...
                      <div className="media-body">
                        <h6 className="font-weight-semibold mb-1">Studied at <Link href="#" className="btn-link">University</Link></h6>
                        <span>2004-2008</span>
          ...
          <Col xl={6}>
                ...
                <div className="d-flex">
                  <div className="media mt-0">
                    <div className="media-user me-2">
                      <div className=""><img alt="user16" className="rounded-circle avatar avatar-md" src={"../../../assets/images/users/16.jpg"} /></div>
                    </div>
                    <div className="media-body">
                ...
                <div className="media mt-0">
                  <div className="media-user me-2">
                    <div className="avatar-list avatar-list-stacked">
                      <img className="avatar brround" alt="user12" src={"../../../assets/images/users/12.jpg"} />
                      <img className="avatar brround" alt="user2" src={"../../../assets/images/users/2.jpg"} />
                      <img className="avatar brround" alt="user9" src={"../../../assets/images/users/9.jpg"} />
                      <img className="avatar brround" alt="user2" src={"../../../assets/images/users/2.jpg"} />
                      <img className="avatar brround" alt="user4" src={"../../../assets/images/users/4.jpg"} />
                  ...
                  <div className="ms-auto">
                    <div className="d-flex mt-1">
                      <Link className="new me-2 text-muted fs-16" href="#;"><span className=""><i className="fe fe-heart"></i></span></Link>
                      <Link className="new me-2 text-muted fs-16" href="#;"><span className=""><i className="fe fe-message-square"></i></span></Link>
                      <Link className="new text-muted fs-16" href="#;"><span className=""><i className="fe fe-share-2"></i></span></Link>
                    </div>
                  </div>
                </div>
              </Card.Footer>
            ...
            <Card className="border p-0 shadow-none">
              <Card.Body>
                ...
                <div className="mt-4">
                  <div className="d-flex">
                    <img src={"../../../assets/images/media/22.jpg"} alt="user22" className="w-40 m-1 br-5" />
                    <img src={"../../../assets/images//media/24.jpg"} alt="user24" className="w-40 m-1 br-5" />
                  </div>
                  <h4 className="fw-semibold mt-3">There is nothing more beautiful.</h4>
                  <p className="mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which {`don't `}look even slightly believable.
                  </p>
            ...
            <Card className="border p-0 shadow-none">
              <Card.Body>
                ...
                <div className="mt-4">
                  <div className="d-flex">
                    <img src={"../../../assets/images/media/26.jpg"} alt="user26" className="w-30 m-1 br-5" />
                    <img src={"../../../assets/images/media/23.jpg"} alt="user23" className="w-30 m-1 br-5" />
                    <img src={"../../../assets/images/media/21.jpg"} alt="user21" className="w-30 m-1 br-5" />
                  </div>
                  <h4 className="fw-semibold mt-3">There is nothing more beautiful.</h4>
                  <p className="mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which {`don't `}look even slightly believable.
                  </p>
              ...
              <Card.Body>
                <div className="">
                  <div className="media overflow-visible">
                    <img className="avatar brround avatar-md me-3" src={"../../../assets/images/users/18.jpg"} alt="avatar-user18" />
                  ...
                  <div className="media overflow-visible mt-sm-5">
                    ...
                    <div className="media-body valign-middle mt-2">
                      <Link href="#" className="fw-semibold text-dark">Lillian Quinn</Link>
                  ...
                  <div className="media overflow-visible mt-sm-5">
                    <img className="avatar brround avatar-md me-3" src={"../../../assets/images/users/2.jpg"} alt="avatar-user2" />
                    <div className="media-body valign-middle mt-2">
                      <Link href="#" className="text-dark fw-semibold">Harry Fisher</Link>
              ...
              <Card.Body>
                <div className="">
                  <div className="media media-xs overflow-visible">
                    <img className="avatar bradius avatar-xl me-3" src={"../../../assets/images/users/12.jpg"} alt="avatar-user12" />
                  ...
                  <div className="media media-xs overflow-visible mt-5">
                    <img className="avatar bradius avatar-xl me-3" src={"../../../assets/images/users/2.jpg"} alt="avatar-user2" />
                    <div className="media-body valign-middle">
                  ...
                  <div className="media media-xs overflow-visible mt-5">
                    <img className="avatar bradius avatar-xl me-3" src={"../../../assets/images/users/9.jpg"} alt="avatar-user9" />
                    <div className="media-body valign-middle">
                      <Link href="#" className="fw-semibold text-dark">Irene Harris</Link>
                      <p className="text-muted mb-0">There are many variations of passages of Lorem Ipsum available ...</p>
                    </div>
                  ...
                  <div className="media media-xs overflow-visible mt-5">
                    <img className="avatar bradius avatar-xl me-3" src={"../../../assets/images/users/4.jpg"} alt="avatar-user4" />
                    <div className="media-body valign-middle">
                  ...
                  <div className="media media-xs overflow-visible">
                    ...
                    <div className="">
                      <div className="social social-profile-buttons float-sm-end">
                        <Link className="social-icon bg-white" href="#"><i className="fa fa-facebook"></i></Link>
                        <Link className="social-icon bg-white" href="#"><i className="fa fa-twitter"></i></Link>
                        <Link className="social-icon bg-white" href="#"><i className="fa fa-linkedin"></i></Link>
                      </div>
                    </div>
                  </div>
                  <div className="media media-xs overflow-visible mt-5">
