    ...
    <Row>
        ...
        <Card>
          <ListGroup className="list-group-transparent mb-0 mail-inbox pb-3" defaultActiveKey='#link'>
            <div className="mt-4 mb-4 mx-4 text-center">
              <Link href={`/components/pages/mail-compose/`} className="btn btn-primary btn-lg d-grid">Compose</Link>
            </div>
            <Link href={`/components/pages/mail-index/`} className=""><ListGroup.Item eventKey='#link' className="d-flex align-items-center mx-4">
              <span className="icons"><i className="ri-mail-line"></i></span> Inbox <Badge bg='secondary' className="ms-auto bradius">14</Badge>
            </ListGroup.Item></Link>
            <Link href="#"><ListGroup.Item eventKey="#link1" className="d-flex align-items-center mx-4">
              <span className="icons"><i className="ri-mail-open-line"></i></span> Drafts
            </ListGroup.Item></Link>
            <Link href="#"><ListGroup.Item eventKey="#link2" className="d-flex align-items-center mx-4">
              <span className="icons"><i className="ri-star-line"></i></span> Starred <Badge bg='success' className="ms-auto bradius">03</Badge>
            </ListGroup.Item></Link>
            <Link href="#"><ListGroup.Item eventKey="#link3" className="d-flex align-items-center mx-4">
              <span className="icons"><i className="ri-price-tag-3-line"></i></span> Tags
            </ListGroup.Item></Link>
            <Link href="#"><ListGroup.Item eventKey="#link4" className="d-flex align-items-center mx-4">
              <span className="icons"><i className="ri-mail-send-line"></i></span> Sent Mail
            </ListGroup.Item></Link>
            <Link href="#"><ListGroup.Item eventKey="#link5" className="d-flex align-items-center mx-4">
      ...
      <Col xl={9}>
        <Card>
          ...
          <Card.Body>
            ...
            <div className="eamil-body mt-5">
              ...
              <div className="email-attch">
                <h6 className="font-weight-semibold">3 Attachments <Link href={`/components/filemanager/file-details/`}>View</Link></h6>
              </div>
              <Row className="attachments-doc">
                <Col xl={3} lg={3} md={4} sm={4} className="mb-2 mb-sm-0">
                  <div className="border overflow-hidden p-0 br-7">
                    <Link href={`/components/filemanager/file-details/`}><img src={"../../../assets/images/media/8.jpg"} className="card-img-top" alt="img" /></Link>
                    <div className="p-3 text-center">
                      <Link href={`/components/filemanager/file-details/`} className="fw-semibold fs-15 text-dark">Image.jpg</Link>
                ...
                <Col xl={3} lg={3} md={4} sm={4} className="mb-2 mb-sm-0">
                  <div className="border overflow-hidden p-0 br-7">
                    <Link href={`/components/filemanager/file-details/`}><img src={"../../../assets/images/media/22.jpg"} className="card-img-top" alt="img" /></Link>
                    <div className="p-3 text-center">
                      <Link href={`/components/filemanager/file-details/`} className="fw-semibold fs-15 text-dark">Image2.jpg</Link>
                ...
                <Col xl={3} lg={3} md={4} sm={4} className="mb-2 mb-sm-0">
                  <div className="border overflow-hidden p-0 br-7">
                    <Link href={`/components/filemanager/file-details/`}><img src={"../../../assets/images/media/6.jpg"} className="card-img-top" alt="img" /></Link>
                    <div className="p-3 text-center">
                      <Link href={`/components/filemanager/file-details/`} className="fw-semibold fs-15 text-dark">Image3.jpg</Link>
          ...
          <Card.Footer>
            <Link className="btn btn-primary mt-1 mb-1 me-2" href="#"><i className="fa fa-reply"></i> Reply</Link>
            <Link className="btn btn-secondary mt-1 mb-1 me-2" href="#"><i className="fa fa-share"></i> Forward</Link>
          </Card.Footer>
        </Card>
      </Col>
    </Row>
