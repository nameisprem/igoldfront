                        ...
                        <div className="main-chat-contacts-slider lSSlideWrapper usingCss">
                          <div className="main-chat-contacts lightSlider lsGrab lSSlide ps-0" id="chatActiveContacts">
                            <div className="lslide active position-relative">
                              <img className="avatar avatar-md bradius cover-image" alt='user5' src={"../../../assets/images/users/5.jpg"} />
                              <span className="avatar-status bg-secondary"></span>
                              <small>Ariana</small>
                            </div>
                            <div className="lslide position-relative">
                              <img className="avatar avatar-md bradius cover-image" alt='user9' src={"../../../assets/images/users/9.jpg"} />
                              <span className="avatar-status bg-red"></span>
                              <small>Monino</small>
                            </div>
                            <div className="lslide position-relative">
                              <img className="avatar avatar-md bradius cover-image" alt='user6' src={"../../../assets/images/users/6.jpg"} />
                              <span className="avatar-status bg-green"></span>
                              <small>Reynante</small>
                            </div>
                            <div className="lslide position-relative">
                              <img className="avatar avatar-md bradius cover-image" alt='user7' src={"../../../assets/images/users/7.jpg"} />
                  ...
                  <Tab.Content className=' main-chat-list flex-2'>
                      ...
                      <div className="main-chat-list tab-pane">
                        <Link className="media new border-top-0" href="#">
                          <div className="main-img-user online">
                            <img alt="user5" src={"../../../assets/images/users/5.jpg"} />
                          </div>
                        ...
                        <Link className="media new" href="#">
                          <div className="main-img-user">
                            <img alt="user6" src={"../../../assets/images/users/6.jpg"} /> <span>3</span>
                          </div>
                          <div className="media-body">
                            <div className="media-contact-name">
                        ...
                        <Link className="media new" href="#">
                          <div className="main-img-user"><img alt="user4" src={"../../../assets/images/users/4.jpg"} /></div>
                          <div className="media-body">
                            <div className="media-contact-name">
                        ...
                        <Link className="media new" href="#">
                          <div className="main-img-user"><img alt="user21" src={"../../../assets/images/users/21.jpg"} /></div>
                          <div className="media-body">
                            <div className="media-contact-name">
                        ...
                        <Link className="media new" href="#">
                          <div className="main-img-user"><img alt="user5" src={"../../../assets/images/users/5.jpg"} /></div>
                          <div className="media-body">
                            <div className="media-contact-name">
                        ...
                        <Link className="media new" href="#">
                          <div className="main-img-user"><img alt="user3" src={"../../../assets/images/users/3.jpg"} /></div>
                          <div className="media-body">
                            <div className="media-contact-name">
                        ...
                        <Link className="media new" href="#">
                          <div className="main-img-user"><img alt="user7" src={"../../../assets/images/users/7.jpg"} /></div>
                          <div className="media-body">
                            <div className="media-contact-name">
                        ...
                        <Link className="media new border-bottom-0" href="#">
                          <div className="main-img-user"><img alt="user6" src={"../../../assets/images/users/6.jpg"} /></div>
                          <div className="media-body">
                            <div className="media-contact-name">
                    ...
                    <Tab.Pane eventKey="grp">
                      <div className='tab-content main-chat-list flex-2 ' >
                        <Link href="#" className="d-flex align-items-center media border-top-0">
                          <div className="mb-0 me-2">
                            <div className="main-img-user online text-primary">
                              <img alt="user4" src={"../../../assets/images/users/4.jpg"} /> <span>2</span>
                            </div>
                          </div>
                        ...
                        <Link href="#" className="d-flex align-items-center media">
                          <div className="mb-0 me-2">
                            <div className="main-img-user online">
                              <img alt="user9" src={"../../../assets/images/users/9.jpg"} /> <span>2</span>
                            </div>
                          </div>
                          <div className="align-items-center justify-content-between">
                            <div className="media-body ms-2">
                        ...
                        <Link href="#" className="d-flex align-items-center media">
                          <div className="mb-0 me-2">
                            <div className="main-img-user online">
                              <img alt="user12" src={"../../../assets/images/users/12.jpg"} /> <span>2</span>
                            </div>
                          </div>
                          <div className="align-items-center justify-content-between">
                            <div className="media-body ms-2">
                        ...
                        <Link href="#" className="d-flex align-items-center media">
                          <div className="mb-0 me-2">
                            <div className="main-img-user online">
                              <img alt="user6" src={"../../../assets/images/users/6.jpg"} /> <span>2</span>
                            </div>
                          </div>
                          <div className="align-items-center justify-content-between">
                            <div className="media-body ms-2">
                        ...
                        <Link href="#" className="d-flex align-items-center media">
                          <div className="mb-0 me-2">
                            <div className="main-img-user online">
                              <img alt="user7" src={"../../../assets/images/users/7.jpg"} /> <span>2</span>
                            </div>
                          </div>
                          <div className="align-items-center justify-content-between">
                            <div className="media-body ms-2">
                        ...
                        <div className="text-center p-5">
                          <Link href="#" className="btn btn-outline-primary">Create New Group</Link>
                        </div>
                      </div>
                    </Tab.Pane>
                    <Tab.Pane eventKey="cnts">
                      <div>
                        ...
                        <div className="d-flex align-items-center media">
                          <div className="mb-0 me-2">
                            <div className="main-img-user online">
                              <img alt="user3" src={"../../../assets/images/users/3.jpg"} /> <span>2</span>
                            </div>
                          </div>
                          <div className="align-items-center justify-content-between">
                            <div className="media-body ms-2">
                      ...
                      <div className="mt-4">
                        ...
                        <div className="d-flex align-items-center media">
                          <div className="mb-0 me-2">
                            <div className="main-img-user online">
                              <img alt="user5" src={"../../../assets/images/users/5.jpg"} /> <span>2</span>
                            </div>
                          </div>
                          <div className="align-items-center justify-content-between">
                            <div className="media-body ms-2">
                      ...
                      <div className="mt-4">
                        ...
                        <div className="d-flex align-items-center media">
                          <div className="mb-0 me-2">
                            <div className="main-img-user online">
                              <img alt="user2" src={"../../../assets/images/users/2.jpg"} /> <span>2</span>
                            </div>
                          </div>
                          <div className="align-items-center justify-content-between">
                            <div className="media-body ms-2">
                      ...
                      <div className="mt-4">
                        ...
                        <div className="d-flex align-items-center media">
                          <div className="mb-0 me-2">
                            <div className="main-img-user online">
                              <img alt="user1" src={"../../../assets/images/users/1.jpg"} /> <span>2</span>
                            </div>
                          </div>
                          <div className="align-items-center justify-content-between">
                            <div className="media-body ms-2">
                    ...
                    <Tab.Pane eventKey="net">
                      ...
                      <div className="">
                        <div className="d-flex py-4 px-6 fw-bold"><span>Rooms</span>
                          <Link href="#" className="ms-auto"><i className="fe fe-plus"></i></Link>
                        </div>
                        <Link href="#" className="align-items-center media">
                          <div className="align-items-center justify-content-between">
                            <div className="media-body ms-4">
              ...
              <div className="main-content-app">
                ...
                <div className="">
                  ...
                  <div className="d-flex mb-2 mt-2">
                    <div>
                      <Link className="nav-link border rounded-pill chat-profile me-2" href=""><i className="fe fe-phone"></i></Link>
                    </div>
                    <div className="ms-2">
                  ...
                  <div className="d-flex mb-2 mt-2">
                    <div>
                      <Link className="nav-link border rounded-pill chat-profile me-2" href=""><i className="fe fe-linkedin"></i></Link>
                    </div>
                    <div className="ms-2">
