              ...
              <Row className="align-items-center">
                <Col md={12} className="social text-center">
                  <ul className="text-center d-inline-block">
                    <li>
                      <Link className="social-icon" href=""><i className="fa fa-facebook"></i></Link>
                    </li>
                    <li>
                      <Link className="social-icon" href=""><i className="fa fa-twitter"></i></Link>
                    </li>
                    <li>
                      <Link className="social-icon" href=""><i className="fa fa-rss"></i></Link>
                    </li>
                    <li>
                      <Link className="social-icon" href=""><i className="fa fa-youtube"></i></Link>
                    </li>
                    <li>
                      <Link className="social-icon" href=""><i className="fa fa-linkedin"></i></Link>
                    </li>
                    <li>
                      <Link className="social-icon" href=""><i className="fa fa-google-plus"></i></Link>
                    </li>
                  </ul>
                </Col>
                <Col lg={12} sm={12} className="mt-3 mt-lg-0 text-center">
                  Copyright © 2022 <Link href="#">Sash</Link>. Designed with by <Link href="#">Spruko</Link> All rights reserved.
                </Col>
              </Row>
            </div>
          </Card.Footer>
        ...
        <Card>
          ...
          <Card.Body>
            <div className="top-footer">
              <Row>
                ...
                <Col lg={4} sm={12} md={4}>
                  <h6>Location</h6>
                  <ul className="list-unstyled mb-4">
                    <li><Link href="#">Address1:7363 Old Livingston Drive Dyersburg</Link></li>
                    <li><Link href="#">Address2:4 Harrison St.Fairborn, OH 45324</Link></li>
                    <li><Link href="#">Phno1: +123 456 8976</Link></li>
                    <li><Link href="#">Phno2: +567 234 7865</Link></li>
                    <li><Link href="#">Mail1: yourdomain@gmail.com</Link></li>
                    <li><Link href="#">Mail2: infodomain@gmail.com</Link></li>
                  </ul>
                </Col>
              </Row>
            </div>
            <footer className="main-footer ps-0 pe-0">
              <Row>
                <Col xl={8} lg={12} md={12} className="footer1">Copyright © 2022 <Link href="#">Sash</Link>. Designed with <span className="fa fa-heart text-danger"></span> by <Link href="#"> Spruko </Link>
                </Col>
              ...
              <Row>
                ...
                <Col lg={4} sm={12} md={4}>
                  ...
                  <ul className="footer-payments">
                    <li><Link href="#"><i className="fa fa-cc-amex text-muted" aria-hidden="true"></i></Link></li>
                    <li><Link href="#"><i className="fa fa-cc-visa text-muted" aria-hidden="true"></i></Link></li>
                    <li><Link href="#"><i className="fa fa-credit-card-alt text-muted" aria-hidden="true"></i></Link></li>
                    <li><Link href="#"><i className="fa fa-cc-mastercard text-muted" aria-hidden="true"></i></Link></li>
                    <li><Link href="#"><i className="fa fa-cc-paypal text-muted" aria-hidden="true"></i></Link></li>
                  </ul>
                </Col>
              </Row>
            </div>
