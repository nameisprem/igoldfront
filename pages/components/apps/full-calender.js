                    ...
                    <div className="mt-5">
                      ...
                      <Card className="border p-0 pt-3">
                        <Card.Body className="pt-3">
                          ...
                          <Link href="#" className="btn btn-primary btn-sm me-3 mb-3">Urgent</Link>
                          <Link href="#" className="btn btn-secondary btn-sm mb-3">Face to Face</Link>
                        </Card.Body>
                        <Card.Footer>
                          <div className="media media-xs overflow-visible">
                            <img className="avatar brround avatar-md me-3" src={"../../../assets/images/users/12.jpg"} alt="avatar-img" />
                            <div className="media-body valign-middle">
                              <Link href={`/components/pages/profile/`} className=" fw-semibold text-dark">John Paige</Link><br />
                              <Link href={`/components/pages/profile/`} className="text-muted mb-0"> View client profile</Link>
                            </div>
                          </div>
                        </Card.Footer>
                      </Card>
                      <Card className="border p-0 pt-3">
                        <Card.Body className="pt-3">
                          ...
                          <Link href="#" className="btn btn-primary btn-sm me-3 mb-3">Urgent</Link>
                          <Link href="#" className="btn btn-danger btn-sm mb-3">Online Meeting</Link>
                        </Card.Body>
                        <Card.Footer>
                          <div className="media media-xs overflow-visible">
                            <img className="avatar brround avatar-md me-3" src={"../../../assets/images/users/16.jpg"} alt="avatar-img" />
                            <div className="media-body valign-middle">
                              <Link href={`/components/pages/profile/`} className=" fw-semibold text-dark">Mozelle Belt</Link><br />
                              <Link href={`/components/pages/profile/`} className="text-muted mb-0"> View client profile</Link>
                            </div>
                          </div>
                        </Card.Footer>
