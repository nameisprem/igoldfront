        ...
        <Card className="cart">
            ...
            <tbody>
                {FiltershopingData !== "" ? FiltershopingData.map((list) => (
                    <tr key={Math.random()}>
                        ...
                        <Link href='#' onClick={() => { handleRemove(list.id) }}><OverlayTrigger placement="top" overlay={<Tooltip>Delete</Tooltip>}><div className="text-danger bg-danger-transparent btn-icon py-1"><i className="bi bi-trash fs-16"></i></div></OverlayTrigger></Link>
                        </div>
                        </td>
                    </tr>
          ...
          <Card.Footer>
            <Row>
              ...
              <Col md={6} sm={6} className="text-end"><Link href="#" className="btn btn-default btn-md" onClick={() => { sethopingData("") }}>Update Cart</Link></Col>
            </Row>
          </Card.Footer>
        </Card>
      </Col>
        ...
        <Card>
          ...
          <Card.Footer>
            <div className="btn-list d-flex justify-content-between flex-wrap">
              <Link href={`/components/e-commerce/shop/`} className="btn btn-primary"><i className="fa fa-arrow-left mx-1"></i>Continue Shopping</Link>
              <Link href={`/components/e-commerce/checkout`} className="btn btn-success">Check out<i className="fa fa-arrow-right mx-1"></i></Link>
            </div>
          </Card.Footer>
        </Card>
      </Col>
