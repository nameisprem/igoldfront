      ...
      <Row>
                    ...
                    <Tab.Content>
                      <Tab.Pane eventKey="CreditCard">
                        <div className="tab-pane active show" id="tab20">
                          ...
                          <Link href="#" className="btn btn-lg btn-primary mt-4">Confirm</Link>
                        </div>
                      </Tab.Pane>
        ...
        <Col xl={4} md={12}>
          <Card className="cart">
            ...
            <Card.Footer>
              <Link href="#" className="btn btn-primary">Deliver to this Address</Link>
            </Card.Footer>
          </Card>
          <Card className="cart">
            <Card.Header>
              ...
              {FiltercartData.map((idx) => (
                <div className="" key={Math.random()}>
                  <div className="d-flex">
                    ...
                    <div className="ms-3">
                      <h4 className="mb-1 fw-semibold fs-14"><Link href={`/components/e-commerce/product-details/`}>{idx.heading}</Link></h4>
