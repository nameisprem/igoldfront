                  ...
                  <Row>
                    ...
                    <Col xl={7} lg={6} md={7} sm={6}>
                      <div className="float-sm-end float-none my-1">
                        <Link href={`/components/e-commerce/shopping-cart`} className="btn btn-primary me-2">Add All to Cart</Link>
                        <Link onClick={()=>{setAllData("")}} href="#" className="btn btn-primary">Clear All</Link>
                      </div>
                    </Col>
                  </Row>
                </Card.Body>
                    ...
                    <Card>
                      <div className="product-grid6">
                        ...
                        <Card.Footer className="text-center">
                          <Link href={`/components/e-commerce/shopping-cart`} onClick={() => { AddToCart(idx.id) }} className="btn btn-primary ms-2 mb-1"><i className="fe fe-shopping-cart me-2"></i>Add to cart</Link>
