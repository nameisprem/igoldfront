              ...
              <Row className="row-sm">
                    ...
                    <Col xl={12}>
                      ...
                      <div className="preview-pic tab-content text-center ">
                        <div className="tab-pane active" id="pic-1">
                          <img src={defaultData && defaultData.preview} alt="img" className={defaultData && defaultData.preview !== "../../../assets/images/png/5.png" ? "img-fluid mx-auto d-block" : ""} />
                        </div>
                    </div>
                      <ul className="preview-thumbnail nav nav-tabs">
                        {defaultData &&
                          defaultData.imges.map((ele) => {
                            return (
                              <li key={Math.random() + ele} className="active"><Link href='#' onClick={() => { setdefaultData({ ...defaultData, preview: ele.img, }); }}><img src={ele.img} alt="img" /></Link></li>
                            );
                          })}
                      </ul>
                ...
                <Col xl={7} lg={12} md={12} className="details mt-4 mt-xl-0">
                  <div className="mt-2 mb-4">
                    ...
                    <div className=" mt-4 mb-5 d-inline-flex"><span className="fw-bold me-2">Offer : </span><span className="fw-bold text-primary">15% Cashback </span>by using icici bank credit card.<small className="text-muted">Terms and Conditions Applies</small></div>
            ...
            <Col>
                <div className="mb-2 me-2 sizes">
                    ...
                    <div className="btn-list mt-4">
                      <Link href={`/components/e-commerce/shopping-cart/`}  onClick={() => { AddToCart(id) }} className="btn ripple btn-primary me-2"><i className="fe fe-shopping-cart"> </i> Add to cart</Link>
                      <Link href={`/components/e-commerce/checkout/`} onClick={() => { AddToCart(id) }}  className="btn ripple btn-secondary"><i className="fe fe-credit-card"> </i> Buy Now</Link>
                    </div>
                  </div>
                </Col>
              </Row>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="media mb-5">
                <div className="me-3">
                  <Link href="#"> <img className="media-object rounded-circle thumb-sm" alt="64x64" src={"../../../assets/images/users/5.jpg"} /> </Link>
                </div>
                <div className="media-body">
                  ...
                  <span className="reply" id="6">
                    <Link href="#"><Badge bg="btn-primary-light" className="btn-primary-light rounded-pill py-2 px-3"><i className="fe fe-corner-up-left me-1"></i>Reply</Badge></Link>
                  </span>
                </div>
              </div>
              <div className="media mb-5">
                <div className=" me-3">
                  <Link href="#"> <img className="media-object rounded-circle thumb-sm" alt="64x64" src={"../../../assets/images/users/15.jpg"} /> </Link>
                </div>
                <div className="media-body">
            ...
            <Card>
              <div className="product-grid6">
                <div className="product-image6 p-5">
                  <ul className="icons">
                    <li>
                      <Link href={`/components/e-commerce/shopping-cart/`} className="btn bg-primary text-white border-primary border"> <i className="fe fe-eye ">  </i> </Link>
                    </li>
                    <li><Link href={`/components/e-commerce/add-product/`} className="btn bg-success text-white border-success border"><i className="fe fe-edit"></i></Link></li>
                    <li><Link href="#" className="btn bg-danger text-white border-danger border" onClick={() => handleRemove(idx.id)}><i className="fe fe-x"></i></Link></li>
                  </ul>
                  <Link href={`/components/e-commerce/product-details/`} className="bg-light">
                ...
                <Card.Footer className="text-center">
                  <Link href={`/components/e-commerce/shopping-cart/`} onClick={() => { AddToCart(idx.id) }}><button type="button" className="btn btn-primary mb-1 ms-3"><i className="fe fe-shopping-cart me-2"></i>Add to cart</button></Link>
                  <Link href={`/components/e-commerce/wishlist/`}><button type="button" className="btn btn-outline-primary mb-1 ms-3"><i className="fe fe-heart me-2"></i>Add to wishlist</button></Link>
                </Card.Footer>
              </div>
            </Card>
          </Col>
