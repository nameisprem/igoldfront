          ...
          <Row>
            <Col md={12} lg={12}>
              <Card>
                ...
                <Card.Body>
                  <ListGroup>
                    <ListGroup.Item className="border-0 p-0"> <Link href="#"><i className="fe fe-chevron-right"></i> Mens </Link><span className="product-label">22</span> </ListGroup.Item>
                    <ListGroup.Item className="border-0 p-0"> <Link href="#"><i className="fe fe-chevron-right"></i> Womens </Link><span className="product-label">15</span> </ListGroup.Item>
                    <ListGroup.Item className="border-0 p-0"> <Link href="#"><i className="fe fe-chevron-right"></i> Kids </Link><span className="product-label">10</span> </ListGroup.Item>
                    <ListGroup.Item className="border-0 p-0"> <Link href="#"><i className="fe fe-chevron-right"></i> Others </Link><span className="product-label">88</span> </ListGroup.Item>
                  </ListGroup>
                </Card.Body>
              </Card>
              <Card>
                ...
                <Card.Body>
                  <div className="">
                    ...
                    <div className="d-flex overflow-visible">
                      <img className="avatar bradius avatar-xl me-4 p-2 bg-white border" src={"../../../assets/images/products/11.jpg"} alt="avatar-img" />
                      <div className="media-body valign-middle">
                        <Link href="#" className="fw-semibold text-dark">Hand Bag</Link>
                    ...
                    <div className="d-flex overflow-visible mt-5">
                      <img className="avatar bradius avatar-xl me-4 p-2 bg-white border" src={"../../../assets/images/products/1.jpg"} alt="avatar-img" />
                      <div className="media-body valign-middle">
                        <Link href="#" className="fw-semibold text-dark">Laptop Bag</Link>
                        <div className="mb-1 text-warning">
                          <i className="fa fa-star"></i>
                          <i className="fa fa-star"></i>
                          <i className="fa fa-star"></i>
                    ...
                    <div className="d-flex overflow-visible mt-5">
                      <img className="avatar bradius avatar-xl me-4 p-2 bg-white border" src={"../../../assets/images/products/5.jpg"} alt="avatar-img" />
                      <div className="media-body valign-middle">
                        <Link href="#" className="fw-semibold text-dark">Watch</Link>
                        <div className="mb-1 text-warning">
                          <i className="fa fa-star"></i>
                          <i className="fa fa-star"></i>
                          <i className="fa fa-star"></i>
                ...
                <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                  ...
                  <Card.Body className="p-4 bg-white br-7">
                    <Row>
                      ...
                      <Col xl={3} lg={12}>
                        <Link href={`/components/e-commerce/add-product/`} className="btn btn-primary btn-block float-end my-2"><i className="fa fa-plus-square me-2"></i>New Product</Link>
                      </Col>
                    </Row>
                  </Card.Body>
                              ...
                              <Card>
                                <div className="product-grid6">
                                  <div className="product-image6 p-5">
                                    <ul className="icons">
                                      <li>
                                        <Link href={`/components/e-commerce/product-details/`} className="btn btn-primary"> <i className="fe fe-eye">  </i> </Link>
                                      </li>
                                      <li><Link href={`/components/e-commerce/add-product/`} className="btn btn-success"><i className="fe fe-edit"></i></Link></li>
                                      <li><Link href="#" className="btn btn-danger"><i className="fe fe-x"></i></Link></li>
                                    </ul>
                                  ...
                                  <Card.Body className="pt-0">
                                    <div className="product-content text-center">
                                      <h1 className="title fw-bold fs-20"><Link href={`/components/e-commerce/product-details/`}>{idx.heading}</Link></h1>
                                  ...
                                  <Card.Footer className="text-center">
                                    <Link href={`/components/e-commerce/shopping-cart/`} className="btn me-2 btn-primary mb-1" onClick={() => { AddToCart(idx.id) }}><i className="fe fe-shopping-cart mx-2" ></i>Add to cart</Link>
                                    <Link href={`/components/e-commerce/wishlist/`} className="btn me-2 btn-outline-primary mb-1"><i className="fe fe-heart mx-2 wishlist-icon"></i>Add to wishlist</Link>
                                  </Card.Footer>
                                </div>
                              </Card>
                            </Col>
                                  ...
                                  <Row className="g-0">
                                    ...
                                    <Col xl={3} lg={12} md={12}>
                                      <div className="product-list">
                                        <div className="product-image">
                                          <ul className="icons">
                                            <li><Link href={`/components/e-commerce/product-details/`} className="btn btn-primary"><i className="fe fe-eye text-white "></i></Link></li>
                                            <li><Link href={`/components/e-commerce/add-product/`} className="btn btn-success"><i className="fe fe-edit text-white "></i></Link></li>
                                            <li><Link href={`/components/e-commerce/wishlist/`} className="btn btn-danger"><i className="fe fe-x text-white"></i></Link></li>
                                          </ul>
                                        </div>
                                        <div className="br-be-0 br-te-0">
                                          <Link href={`/components/e-commerce/product-details/`} className="">
                                    ...
                                    <Col xl={3} lg={12} md={12} className="my-auto">
                                      <Card.Body className="p-0">
                                        ...
                                        <Link href={`/components/e-commerce/shopping-cart/`} className="btn me-2 btn-primary btn-block" onClick={() => { AddToCart(idx.id) }}><i className="fe fe-shopping-cart mx-2"></i>Add to cart</Link>
                                        <Link href={`/components/e-commerce/wishlist/`} className="btn me-2 btn-outline-primary btn-block mt-2"><i className="fe fe-heart mx-2 wishlist-icon"></i>Add to wishlist</Link>
                                      </Card.Body>
                                    </Col>
                                  </Row>
                                </Card.Body>
