...
import { LightGallery, RecentFolder } from '../../../shared/data/DataFileManger/DataFIleDetails';
      ...
      <Col xl={8} lg={12} md={12}>
        <Card className="custom-card overflow-hidden">
          <Card.Body className="p-3">
            <Link href="#"><img src={"../../../assets/images/media/files/09.jpg"} alt="img" className="br-5 w-100" /></Link>
          </Card.Body>
        </Card>
