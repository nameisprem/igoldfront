      ...
      <Col lg={6}>
        <Card className="custom-card">
          ...
          <Card.Body className="p-4 p-sm-5">
            ...
            <div className="tags">
              <ButtonGroup className="file-attach m-2" role="group" aria-label="Basic example">
                <Link href='#' className="btn btn-primary text-white"><i className="mdi mdi-file-image mx-2"></i>Image01..._jpg</Link>
                <Link href='#' className="btn btn-close btn-primary text-white" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </Link>
              </ButtonGroup>

              <ButtonGroup className="file-attach m-2" role="group" aria-label="Basic example">
                <Link href='#' className="btn btn-outline-secondary"><i className="mdi mdi-file-image me-2"></i> Image_file.jpg </Link>
                <Link href='#' className="btn btn-close btn-outline-secondary" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </Link>
              </ButtonGroup>

              <ButtonGroup className="file-attach m-2" role="group" aria-label="Basic example">
                <Link href='#' className="btn btn-success-light"><i className="mdi mdi-file-image me-2"></i> Image_file.jpg </Link>
                <Link href='#' className="btn btn-close btn-success-light" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </Link>
              </ButtonGroup>
            </div>
      ...
      <Col lg={6}>
        <Card className="custom-card">
          ...
          <Card.Body className="p-4 p-sm-5">
            ...
            <div className="tags">
              <ButtonGroup className="file-attach m-2" role="group" aria-label="Basic example">
                <Link href='#' className="btn btn-pill btn-info text-white"><i className="mdi mdi-file-image mx-2"></i>Image01..._jpg</Link>
                <Link href='#' className="btn btn-pill btn-close btn-info text-white" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </Link>
              </ButtonGroup>

              <ButtonGroup className="file-attach m-2" role="group" aria-label="Basic example">
                <Link href='#' className="btn btn-pill btn-outline-warning"><i className="mdi mdi-file-image me-2"></i> Image_file.jpg </Link>
                <Link href='#' className="btn btn-pill btn-close btn-outline-warning" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </Link>
              </ButtonGroup>

              <ButtonGroup className="file-attach m-2" role="group" aria-label="Basic example">
                <Link href='#' className="btn btn-pill btn-danger-light"><i className="mdi mdi-file-image me-2"></i> Image_file.jpg </Link>
                <Link href='#' className="btn btn-pill btn-close btn-danger-light" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </Link>
              </ButtonGroup>
            </div>
      ...
      <Col lg={6}>
        <Card className="custom-card">
          ...
          <Card.Body className="p-4 p-sm-5">
            ...
            <div className="tags">
              <ButtonGroup className="file-attach m-2" role="group" aria-label="Basic example">
                <Link href='#' className="btn btn-sm btn-primary text-white"><i className="mdi mdi-file-image mx-2"></i>Image01..._jpg</Link>
                <Link href='#' className="btn btn-close btn-sm btn-primary text-white" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </Link>
              </ButtonGroup>

              <ButtonGroup className="file-attach m-2" role="group" aria-label="Basic example">
                <Link href='#' className="btn btn-secondary text-white"><i className="mdi mdi-file-excel me-2"></i>Document.exl</Link>
                <Link href='#' className="btn btn-close btn-secondary text-white" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </Link>
              </ButtonGroup>

              <ButtonGroup className="file-attach m-2" role="group" aria-label="Basic example">
                <Link href='#' className="btn btn-lg btn-pink"><i className="mdi mdi-file-pdf fs-20 me-2"></i>AMN0012.pdf</Link>
                <Link href='#' className="btn btn-close btn-lg btn-pink" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </Link>
              </ButtonGroup>
            </div>
      ...
      <Col lg={6}>
        <Card className="custom-card">
          ...
          <Card.Body className="p-4 p-sm-5">
            ...
            <div className="tags">
              <ButtonGroup className="file-attach m-2" role="group" aria-label="Basic example">
                <Link href='#' className="btn btn-pill btn-sm btn-primary text-white"><i className="mdi mdi-file-image me-2"></i>Image01..._jpg</Link>
                <Link href='#' className="btn btn-pill btn-close btn-sm btn-primary text-white" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </Link>
              </ButtonGroup>

              <ButtonGroup className="file-attach m-2" role="group" aria-label="Basic example">
                <Link href='#' className="btn btn-pill btn-secondary text-white"><i className="mdi mdi-file-excel me-2"></i>Document.exl</Link>
                <Link href='#' className="btn btn-pill btn-close btn-secondary text-white" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </Link>
              </ButtonGroup>

              <ButtonGroup className="file-attach m-2" role="group" aria-label="Basic example">
                <Link href='#' className="btn btn-pill btn-lg btn-pink"><i className="mdi mdi-file-pdf fs-20 me-2"></i>AMN0012.pdf</Link>
                <Link href='#' className="btn btn-pill btn-close btn-lg btn-pink" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </Link>
              </ButtonGroup>
            </div>
                  ...
                  <Col xl={2} lg={3} md={4} sm={4} >
                    <div className="file-image p-2">
                      <Link href={`/components/filemanager/file-details/`}>
                        <img src={"../../../assets/images/products/3.jpg"} alt="png-4" className="w-100" />
                      </Link>
                      <ul className="icons">
                        <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                        <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
                        <li><Link href={`/components/filemanager/file-details/`} className="btn bg-primary"><i className="fe fe-eye"></i></Link></li>
                      </ul>
                      <Link href="#"><span className="file-name">Image01.jpg</span></Link>
                    </div>
                  </Col>
                  <Col xl={2} lg={3} md={4} sm={4}>
                    <div className="file-image p-2">
                      <Link href={`/components/filemanager/file-details/`}>
                        <img src={"../../../assets/images/media/files/11.jpg"} alt="file-2" className="w-100" />
                      </Link>
                      <ul className="icons">
                        <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                        <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
                      ...
                      <Link href="#"><span className="file-name">Image02.jpg</span></Link>
                    </div>
                  </Col>
                  <Col xl={2} lg={3} md={4} sm={4}>
                    <div className="file-image p-2">
                      <Link href={`/components/filemanager/file-details/`}>
                        <img src={"../../../assets/images/media/files/12.jpg"} alt="file-3"className="w-100" />
                      </Link>
                      <ul className="icons">
                        <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                        <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
                      ...
                      <Link href="#"><span className="file-name">Image03.jpg</span></Link>
                    </div>
                  </Col>
                  <Col xl={2} lg={3} md={4} sm={4}>
                    <div className="file-image p-2">
                      <Link href={`/components/filemanager/file-details/`}>
                        <img src={"../../../assets/images/media/files/13.jpg"} alt="file-4" className="w-100" />
                      </Link>
                      <ul className="icons">
                        <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                        <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
                      ...
                      <Link href="#"><span className="file-name">Image04</span></Link>
                    </div>
                  </Col>
                  <Col xl={2} lg={3} md={4} sm={4}>
                    <div className="file-image p-2">
                      <Link href={`/components/filemanager/file-details/`}>
                        <img src={"../../../assets/images/media/files/14.jpg"} alt="file-5" className="w-100" />
                      </Link>
                      <ul className="icons">
                        <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                        <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
                      ...
                      <Link href="#"><span className="file-name">Image05.jpg</span></Link>
                    </div>
                  </Col>
                  <Col xl={2} lg={3} md={4} sm={4}>
                    <div className="file-image p-2">
                      <Link href={`/components/filemanager/file-details/`}>
                        <img src={"../../../assets/images/media/files/10.jpg"} alt="file-1" className="w-100" />
                      </Link>
                      <ul className="icons">
                        <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                        <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
                      ...
                      <Link href="#"><span className="file-name">Image06.jpg</span></Link>
                    </div>
                  </Col>
                </Row>
              </div>
          ...
          <Card.Body>
            <div className="text-wrap">
              <div className="file-image-1">
                <Link href={`/components/filemanager/file-details/`}>
                  <img src={"../../../assets/images/products/3.jpg"} className="br-5" alt="pngs-4" />
                </Link>
                <ul className="icons">
                  <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                  <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
              ...
              <div className="file-image-1">
                <Link href={`/components/filemanager/file-details/`}><img src={"../../../assets/images/media/files/documents/1.png"} alt="file-details" /></Link>
                <ul className="icons">
                  <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                  <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
                  <li><Link href={`/components/filemanager/file-details/`} className="btn bg-primary"><i className="fe fe-eye"></i></Link></li>
              ...
              <div className="file-image-1">
                <Link href={`/components/filemanager/file-details/`}><img src={"../../../assets/images/media/files/documents/4.png"} alt="file-2" /></Link>
                <ul className="icons">
                  <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                  <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
                  <li><Link href={`/components/filemanager/file-details/`} className="btn bg-primary"><i className="fe fe-eye"></i></Link></li>
              ...
              <div className="file-image-1">
                <Link href={`/components/filemanager/file-details/`}><img src={"../../../assets/images/media/files/documents/3.png"} alt="file-1" /></Link>
                <ul className="icons">
                  <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                  <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
                  <li><Link href={`/components/filemanager/file-details/`} className="btn bg-primary"><i className="fe fe-eye"></i></Link></li>
              ...
              <div className="file-image-1">
                <Link href={`/components/filemanager/file-details/`}>
                  <img src={"../../../assets/images/media/files/documents/5.png"} className="br-5" alt="formart" />
                </Link>
                <ul className="icons">
                  <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                  <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
        ...
        <Card>
          ...
          <Card.Body>
            <div className="text-wrap">
              ...
              <div className="file-image-1 file-image-md">
                <Link href={`/components/filemanager/file-details/`}><img src={"../../../assets/images/media/files/documents/1.png"} alt="file-docs" /></Link>
                <ul className="icons">
                  <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                  <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
                  <li><Link href={`/components/filemanager/file-details/`} className="btn bg-primary"><i className="fe fe-eye"></i></Link></li>
              ...
              <div className="file-image-1 file-image-md">
                <Link href={`/components/filemanager/file-details/`}>
                  <img src={"../../../assets/images/media/files/documents/5.png"} className="br-5" alt="file-5" />
                </Link>
                <ul className="icons">
                  <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                  <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
        ...
        <Card>
          ...
          <Card.Body>
            <div className="text-wrap">
              ...
              <div className="file-image-1 file-image-lg">
                <Link href={`/components/filemanager/file-details/`}>
                  <img src={"../../../assets/images/media/files/documents/5.png"} className="br-5" alt="file-3" />
                </Link>
                <ul className="icons">
                  <li><Link href="#" className="btn bg-danger"><i className="fe fe-trash"></i></Link></li>
                  <li><Link href="#" className="btn bg-secondary"><i className="fe fe-download"></i></Link></li>
